...
export default function EmptyTable({ msg, numOfColumns }: { msg: string; numOfColumns: number }) {
  return (
    <TableRow>
      <TableCell colSpan={numOfColumns} sx={{ p: 0 }}>
        <StyledGridOverlay alignItems="center" justifyContent="center" spacing={1}>
          <svg width="70" height="40" viewBox="0 0 184 152" aria-hidden focusable="false">
